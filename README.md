...
React App for finding inspiring things to do. Made with React, fetches data from WordPress site's JSON api. The app is work in progress - still missing some features, for example better search functionality and ability to search things to do by duration.
